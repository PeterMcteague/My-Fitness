...
public class DietScreenMain extends AppCompatActivity {
        ...
        NutritionixRestClient.get(activity, searchQuery + "?fields=item_name%2Cnf_calories%2Cnf_protein&appId=f7a6647d&appKey=973127408431e443f91406c6aa837715", headers.toArray(new Header[headers.size()]),
                null, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, Header[] headers, JSONArray response) {
                        ...
                        foodList = (ListView) findViewById(R.id.diet_food_list);
    ...
    {
        EditText currentCaloriesView = (EditText) findViewById(R.id.diet_calories_entry);
        TextView goalCaloriesView = (TextView) findViewById(R.id.diet_calories_goal_text);
        TextView caloriesTextView = (TextView) findViewById(R.id.diet_calories_text);

        EditText currentProteinView = (EditText) findViewById(R.id.diet_protein_entry);
        TextView goalProteinView = (TextView) findViewById(R.id.diet_protein_goal_text);
        TextView proteinTextView = (TextView) findViewById(R.id.diet_protein_text);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //DATE BUTTON
        Button dateButton = (Button)findViewById(R.id.diet_date_button);
        //Set variables
        ...
        EditText currentCaloriesView = (EditText) findViewById(R.id.diet_calories_entry);
        EditText currentProteinView = (EditText) findViewById(R.id.diet_protein_entry);
        EditText foodEntryView = (EditText) findViewById(R.id.diet_food_entry);
        ...
        currentCaloriesView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                dh.updateDietEntry(diet,timeInMillis);
                Toast.makeText(getApplicationContext(),"Calories updated.",Toast.LENGTH_SHORT);
            }
        });
        ...
        currentProteinView.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                dh.updateDietEntry(diet,timeInMillis);
                Toast.makeText(getApplicationContext(),"Protein updated.",Toast.LENGTH_SHORT);
            }
        });
